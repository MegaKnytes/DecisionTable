...
public class CRServo implements DTDevice {
    ...
    public void registerConfiguration(HardwareMap hardwareMap, ParameterRegistry registry) {
        registry.createParameterGroup(this, "Configuration").addParameter("Name", String.class, () -> crServoName, (crServoName) -> {
    ...
    public void registerParameters(ParameterRegistry registry) {
        registry.createParameterGroup(this, "Value").addParameter("Power", Double.class, () -> crServo.getPower(), (power) -> crServo.setPower(power));
    }
}